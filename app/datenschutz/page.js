export default function Datenschutz() {
  return (
    <div style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
      ...
      <p>Spätere Funktionen (z. B. Werbung, Analytics) werden separat in dieser Erklärung ergänzt.</p>
      
      <h2>Ihre Rechte</h2>
      <p>Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung und Datenübertragbarkeit. Kontaktieren Sie uns hierzu.</p>
      
      <p><small>Dies ist ein Platzhalter für die Entwicklung. Vollständige Erklärung folgt vor Livegang.</small></p>
    </div>
  );
}